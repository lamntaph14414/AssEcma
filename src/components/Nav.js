        ...
        return /* html */`
            <nav>
                <ul class="menu">
                    ...
                    <li class=menu-item><a href="/tintuc" class=menu-item_link>Tin tức</li>
                ...
                <div class="input">
                    <input class="w-60 px-2" type="text" >
                    <button class=" border border-sky-500 bg-blue-900 text-white flex-initial w-30 mr-4"><a class="" href="">Tìm kiếm</a></button>
                </div>
            </nav>`;
    },
};
